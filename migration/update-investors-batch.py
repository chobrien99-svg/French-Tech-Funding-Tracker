...
UPDATES = [
    ('Easy Cash',           ['Multicroissance', 'Ouest Croissance', 'Océan Participations']),
    ('InBrain Pharma',      ['France Parkinson']),
    ('KaraFun Group',       ['Verlinvest', 'Vendis Capital']),
    ('VoilaChef',           ['Provence Angels', 'BNP Paribas', 'Femmes Business Angels',
                              'Bpifrance', 'Individual investors']),
    ('OnParty',             ['Daphné Parrot', 'Roxanne Varza',
                              'Jean-Charles Samuelian-Werve', 'Thibaud Elzière']),
    ('ANYFIELDS',           ['CNES', 'ESA', 'France 2030']),
    ('Circulacar',          ['Crowdcube', 'Movntec', 'Ponton', "GMZ & Son's"]),
    ('Exwayz',              ['CentraleSupélec Venture', 'France 2030']),
    ('Drive Innov',         ['Macif Impact ESS', 'Sienna Investment Managers']),
    ('Daven',               ['Bpifrance', 'Paris Business Angels']),
    ('Elefantia',           ['Bpifrance', 'Carsat Normandie', 'Gérontopôle de Normandie',
                              'OneRagtime', 'Business Angels']),
    ('Karbikes',            ['Business Angels']),
    ('Komia',               ['PMS Group', 'DMG Promotion', 'Vanessa Shi', 'Business Angels',
                              'Réseau Entreprendre Rhône', 'Malick Diouf', 'Bpifrance',
                              'JK Invest']),
    ('SkyVisor',            ['Tomcat Invest', 'Région Île-de-France', 'Bpifrance']),
    ('Goud',                ['Christian Lainé', 'LNA Santé', 'Paul-Henri Dubreuil']),
    ('Onsen',               ["Demeter", "Fonds d\u2019Amor\u00e7age Industriel M\u00e9tropolitain"]),
    ('Eyst Technology',     ['Business Angels', 'Paris Business Angels',
                              'InsurAngels', 'Inovexus']),
]
